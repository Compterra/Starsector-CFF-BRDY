...
public class CometOnHitEffect implements OnHitEffectPlugin {

    private static final Color EXPLOSION_COLOR = new Color(147, 117, 224, 179);
    ...
    private static final String SOUND_ID = "brdy_comet_hit";
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
        ...
        vel.scale(0.6f);
        engine.spawnExplosion(point, vel, EXPLOSION_COLOR, 100f, 0.20f);
