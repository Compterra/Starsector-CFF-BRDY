...
public class SCannonChargeupEffect implements EveryFrameWeaponEffectPlugin {
    ...
    private static final Color CHARGEUP_PARTICLE_COLOR = new Color(135, 255, 180, 50);
    private static final float CHARGEUP_PARTICLE_COUNT_FACTOR = 10.0f;
    private static final float CHARGEUP_PARTICLE_DISTANCE_MAX = 15.0f;
    private static final float CHARGEUP_PARTICLE_DISTANCE_MIN = 4.0f;
    private static final float CHARGEUP_PARTICLE_DURATION = 0.4f;
    private static final float CHARGEUP_PARTICLE_SIZE_MAX = 12.0f;
    private static final float CHARGEUP_PARTICLE_SIZE_MIN = 5.0f;
    private static final Color MUZZLE_FLASH_COLOR = new Color(49, 242, 214, 70);
    private static final float MUZZLE_FLASH_DURATION = 0.045f;
    private static final float MUZZLE_FLASH_SIZE = 95.0f;
    private static final float MUZZLE_OFFSET = 10.0f;
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (charge_level > last_charge_level || weapon_ammo < last_weapon_ammo) {
            ...
            float ship_facing = weapon.getCurrAngle();
