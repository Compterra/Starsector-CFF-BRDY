...
public class StingerOnHitEffect implements OnHitEffectPlugin {

    private static final Color EXPLOSION_COLOR = new Color(183, 255, 182, 195);
    // How likely it is that the extra damage will be applied (1 = 100% chance)
    private static final float EXTRA_DAMAGE_CHANCE = 1f;
    private static final float MIN_EXTRA_DAMAGE = 5f;
    private static final float MAX_EXTRA_DAMAGE = 10f;
    ...
    private static final String SOUND_ID = "ppcprox";
