...
public class brdy_BaseMissile implements MissileAIPlugin, GuidedMissileAI
{
    ...
    public brdy_BaseMissile(MissileAPI missile, ShipAPI launchingShip)
    {
    ...
    {
        // Base helper class; concrete missile AIs provide their own guidance.
    }
    ...
    protected CombatEntityAPI getMouseTarget(ShipAPI launchingShip)
    {
        ...
        List<ShipAPI> directTargets = CombatUtils.getShipsWithinRange(mouseTarget, 300f);
