...
public class SeekerAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    private final float DAMPING = 0.20f;
    ...
    private final Integer RANDOM_TARGET = 2;
    ...
    private final boolean ANTI_FIGHTER = true;    //INCOMPATIBLE WITH ASSAULT
    ...
    private final float MAX_SEARCH_RANGE = 1600;
