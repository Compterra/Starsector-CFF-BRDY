...
public class SparkDriveStats extends BaseShipSystemScript {

    public static final float AFTERIMAGE_DURATION = 0.15f;
    public static final float DAM_MULT = 0.1f;
    public static final Color JITTER_COLOR = new Color(119, 200, 137, 55);
    public static final Color JITTER_UNDER_COLOR = new Color(70, 255, 155, 155);
    public static final float MAX_TIME_MULT = 6f;
    public static final float MIN_TIME_MULT = 0.1f;
    private static final Color COLOR_AFTERIMAGE = new Color(150, 255, 200, 120);
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        ...
        ship.addAfterimage(COLOR_AFTERIMAGE, 0f, 0f, -ship.getVelocity().x * 0.5f, -ship.getVelocity().y * 0.5f,
                           1f * effectLevel,
                           0f, AFTERIMAGE_DURATION, 1f * effectLevel, false, false, false);
    }
