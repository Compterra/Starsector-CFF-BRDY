...
public class BlackrockDimensional extends BaseHullMod {
...
//        INTERRUPTIBLE_PHASE_SYSTEMS.add("brphasecloak");
    ...
    public void advanceInCombat(ShipAPI ship, float amount) {
        ...
        if (!VENT_AI_FOR_THESE_SHIPS.contains(ship.getHullSpec().getBaseHullId())) {
            // Only the dimensional-engine prototype hulls need the custom venting AI.
            return;
        }
    ...
    public boolean isApplicableToShip(ShipAPI ship) {
        ...
        return (ship.getHullSpec().getHullId().startsWith("brdy") && !ship.getVariant().getHullMods().contains(
                "brfluxmod"));
    }
